...
<html lang="en">
	...
	<body>
		<div class="container">
			...
			<header>
				<div class="headDiv colors">Web-Developer-EntryLevel</div>
			</header>
			...
			<section class="main">
				<div class="get-started">
					<div class="artwork">
						<center>
							<img src="images/66750s.jpg" alt="Am a goats" class="fimg">
						</center>
					</div>
					<div class="sub">
			...
			<footer>
				<p>March 28, 2018. Submission for Felix - Favcode Partnership: Made with love by <a href="https://twitter.com/FurtiveCoder">Alfred Nandom Maamdam</a> . </p>
				<p></p>
			</footer>
		</div>
